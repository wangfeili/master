<template>
  <div class="home">
    <el-row display="margin-top:20px">
      ...
      <el-button type="primary" v-on:click.native="addBook()">新增</el-button>
    </el-row>
    <el-row>
      <el-table :data="bookList" style="width: 100%" border>
        ...
        <el-table-column prop="add_name" label="添加时间" min-width="100">
          <template slot-scope="scope"> {{ scope.row.fields.add_name }} </template>
        </el-table-column>
      </el-table>
    </el-row>
  </div>
